...
use crate::installer::downloader::{Downloader, DownloadingError, DownloadingStatusUpdater};
...
impl IntegrityFile {
    ...
    pub fn repair<T: ToString>(&self, game_path: T) -> Result<DownloadingStatusUpdater, DownloadingError> {
